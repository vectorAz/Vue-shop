  ...
  <div class="shop-header">
    ...
    <div class="shop-content">
      ...
      <div class="header-content">
        <h2 class="content-title" @click="ShopbriefShow=true">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="activitySheetShow=true">
      <div class="discounts-left">
        <div class="activity" :class="preferentialClass[info.supports[0].type]">
          <span class="content-tag">
    ...
    <transition name="shopbriefTransition">
      <div class="shop-brief-modal" v-show="ShopbriefShow">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="ShopbriefShow=false">
            <span class="iconfont icon-close"></span>
          </div>
        </div>
        <div class="brief-modal-cover" @click="ShopbriefShow=false"></div>
      </div>
    </transition>
      ...
      <div class="activity-sheet-content">
        ...
        <ul class="list">
          <li
            ...
            :class="preferentialClass[item.type]"
            :key="index"
          >
            <span class="content-tag">
        ...
        <div class="activity-sheet-close" @click="activitySheetShow=false">
          <span class="iconfont icon-close"></span>
        </div>
      </div>
      <div class="activity-sheet-cover" @click="activitySheetShow=false"></div>
    </div>
  </div>
</template>
<script>
...
export default {
  data() {
    return {
      ...
      preferentialClass: ["activity-green", "activity-red", "activity-orange"]
    };
  },
  computed: {
    ...mapState({
...
.shop-header
  ...
  .shop-brief-modal
    ...
    color #333
    &.shopbriefTransition-enter-active, &.shopbriefTransition-leave-active
      transition opacity 0.5s
    &.shopbriefTransition-enter, &.shopbriefTransition-leave-to
      opacity 0
    .brief-modal-cover
      position absolute
      width 100%
